...
public class AppConstants {
    ...
    // Intent actions
    public static final String APP_STATE_INITIALIZED_ACTION = "com.genry.phonegalleryandroid.appinitialized";
    public static final String PHOTO_LIST_REFRESHED_ACTION = "com.genry.phonegalleryandroid.photolistrefreshed";

    public static final String IMAGE_FOLDER_NAME = "PhotoGallry";
    public static final int REQUEST_CODE_PHOTO_SHARED = 12312;

    public static final String DEFAULT_USER_NAME = "Genry";
